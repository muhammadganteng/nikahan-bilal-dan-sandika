...
const App: React.FC = () => {
  ...
  return (
    <div className={`app-container relative ${isAnimationComplete ? 'overflow-y-auto' : 'overflow-hidden h-screen'}`} ref={containerRef}>
      <AnimatePresence>
            ...
            >
              ...
              >
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <p className="font-script text-2xl text-white/90">The Wedding Of</p>
                  <div className="h-px w-8 bg-white/30" />
                </div>

                <h1 className="font-serif text-5xl md:text-6xl tracking-[0.1em] uppercase mb-10 leading-tight drop-shadow-2xl">
            ...
            >
              <div className="max-w-md mx-auto flex flex-col items-center">
                <motion.div
                  ...
                  className="mb-8 text-sage/20"
                >
                  <Heart size={60} fill="currentColor" />
                </motion.div>

                <p className="font-serif text-3xl text-sage mb-6 italic">Assalamualaikum Wr.Wb.</p>
                <p className="text-gray-600 text-[13px] leading-loose mb-12 px-6">
                ...
                <motion.div
                  className="relative py-14 px-8 bg-[#f9fbf9] rounded-[3rem] border border-sage/5 shadow-sm max-w-[320px]"
                >
        ...
        {isAnimationComplete && (
          <div className="relative z-40 bg-white">
            ...
            <div className="h-32 relative overflow-hidden pointer-events-none -mt-10 mb-20">
              <motion.div
                style={{ x: cloud1X }}
                className="absolute -top-10 left-0 w-64 h-32 bg-sage/5 blur-[60px] rounded-full"
              />
              <motion.div
                style={{ x: cloud2X }}
                className="absolute top-10 right-0 w-80 h-40 bg-sage/10 blur-[80px] rounded-full"
              />
            </div>
            ...
            <section className="relative px-6 space-y-48 pb-32">
              ...
              <motion.div {...sectionReveal} className="relative">
                <div className="flex justify-center mb-10">
                  <div className="relative">
                    <motion.div
                      ...
                      className="absolute inset-[-20px] border border-dashed border-sage/20 rounded-full"
                    />
                    <div className="w-72 h-96 bg-white rounded-t-full overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-2 border border-sage/10 relative z-10">
                ...
                <div className="text-center">
                  <p className="font-script text-3xl text-sage mb-4">Mempelai Wanita</p>
              ...
              <div className="flex justify-center py-4">
                ...
                >
                  <span className="font-signature text-9xl text-sage/10">&</span>
                </motion.div>
              </div>
              ...
              <motion.div {...sectionReveal} className="relative">
                ...
                <div className="text-center">
                  <p className="font-script text-3xl text-sage mb-4">Mempelai Pria</p>
            ...
            {/* Agenda Kebahagiaan */}
            <section className="py-40 px-6 bg-[#fcfaf7] relative overflow-hidden">
              {/* Background Awan Tipis Lagi */}
              <motion.div
                animate={{ x: [0, 50, 0], opacity: [0.1, 0.2, 0.1] }}
                transition={{ duration: 10, repeat: Infinity }}
                className="absolute -right-20 top-20 w-64 h-64 bg-sage/20 blur-[100px] rounded-full pointer-events-none"
              />

              <motion.div {...sectionReveal} className="text-center mb-24">
                <Sparkles className="mx-auto text-sage/40 mb-4" size={24} />
                <h2 className="font-serif text-4xl mb-4 tracking-tight">Agenda Kebahagiaan</h2>
                <div className="h-[1px] w-12 bg-sage/30 mx-auto" />
              </motion.div>
              ...
              <div className="space-y-12 max-w-sm mx-auto">
                {[
                  ...
                  <motion.div
                    ...
                    className="bg-white p-10 rounded-[3rem] border border-sage/5 text-center shadow-[0_10px_40px_rgba(0,0,0,0.03)] relative"
                  >
                    <h3 className="font-serif text-2xl mb-8 text-sage tracking-wide">{item.title}</h3>
                    <div className="space-y-6 text-sm text-gray-600">
                      <div className="flex flex-col gap-2">
                        <p className="font-bold text-gray-800">{item.data.date}</p>
                        <p className="font-medium text-sage/80">{item.data.time}</p>
                      </div>
                      <div className="pt-4 flex flex-col items-center gap-4">
                        ...
                        <a href={item.data.mapUrl} target="_blank" className="mt-2 bg-sage text-white px-10 py-3.5 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-md transition-all active:scale-95">Buka Peta</a>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <footer className="py-40 px-10 text-center bg-white border-t border-gray-50 relative overflow-hidden">
              <motion.div
                animate={{ scale: [1, 1.2, 1], opacity: [0.05, 0.1, 0.05] }}
                transition={{ duration: 15, repeat: Infinity }}
                className="absolute inset-0 bg-sage rounded-full blur-[150px] -z-10"
              />
              <motion.div {...sectionReveal}>
                <p className="font-script text-4xl text-sage mb-6">Terima Kasih</p>
                <h4 className="font-serif text-4xl text-gray-800 tracking-[0.2em] uppercase mb-4">{WEDDING_DATA.bride} <br/>& <br/>{WEDDING_DATA.groom}</h4>
                <div className="h-px w-20 bg-sage/20 mx-auto mb-4" />
